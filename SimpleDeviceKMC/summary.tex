...
\hline
\rule{0pt}{2.5ex} 
\textbf{Number Of Molecules}&\textbf{Equilibrated Total PE}&\textbf{Equilibrated PE/molecule}\\
\hhline{|===|}
\ccg 265&\ccg \rule{0pt}{2.5ex}193000&\ccg 728.30\\
250&\rule{0pt}{2.5ex}173000&692.00\\
\ccg 500&\ccg \rule{0pt}{2.5ex}210000&\ccg 420.00\\
\hhline{---}
\end{tabular}\label{table:PE}
\captionof{table}{The potential energy at equilibration for the current system (265 molecules) and the previous two Neat P3HT systems run by Evan (250 and 500 molecules).
